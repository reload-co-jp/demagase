...
const companyInfo = [
  ...
  {
    label: "所在地",
    value: "〒101-0046 東京都千代田区神田佐久間町3-37-1 山茂登ビル 3F",
  },
]
...
const AboutPage: FC = () => {
  ...
  const aboutJsonLd = {
    "@context": "https://schema.org",
    "@type": "AboutPage",
    name: "このサイトについて | DemaGase",
    url: `${SITE_URL}/about/`,
    isPartOf: { "@type": "WebSite", name: "DemaGase", url: SITE_URL },
          ...
          >
            {companyInfo.map((item) => (
              <div key={item.label} style={{ display: "contents" }}>
                <dt style={{ color: "var(--muted)", fontSize: "0.875rem" }}>
                  {item.label}
                </dt>
                <dd
                  style={{
